...
const Pengunjung = () => {
  return (
    <Skeleton isLoaded={true} className="w-full rounded-2xl">
      <div className="flex flex-col items-center justify-center p-4 md:p-9 rounded-2xl bg-brown-lighter text-brown-extreme-dark h-full w-full">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={visitorData}>
            ...
            <Line type="monotone" dataKey="2026" stroke="#ffc658" />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </Skeleton>
